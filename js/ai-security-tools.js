(() => {
  ...
  async function init(){
    ...
    try{
      const response=await fetch('/data/herramientas-seguridad-ia.json',{cache:'no-store'}); if(!response.ok) throw new Error('No se pudo cargar el catálogo');
